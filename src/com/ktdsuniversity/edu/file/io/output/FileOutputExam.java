...
public class FileOutputExam {
	...
	public static void main(String[] args) {
		...
		// 1. 파일을 매번 새롭게 작성하는 경우
		// 2. 파일을 분리해서 작성하는 경우 (순번 리스트, 날짜 기반)
		
		// 파일 데이터베이스에 게시글을 연속해서 작성
		...
		fileDescription.add("파일 내용1");
		fileDescription.add("파일 내용2");
		fileDescription.add("파일 내용3");
		fileDescription.add("파일 내용4");
		fileDescription.add("파일 내용5");
